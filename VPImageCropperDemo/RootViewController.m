...
//  VPImageCropperDemo
//
//  Created by Ray on 16/1/8.
//  Copyright © 2016年 Vinson.D.Warm. All rights reserved.
//
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    [picker dismissViewControllerAnimated:YES completion:^() {
        ...
        // 裁剪
        VPImageCropperViewController *imgEditorVC = [[VPImageCropperViewController alloc] initWithImage:portraitImg circleFrame:CGRectMake(10, 50.0f, self.view.frame.size.width-20, self.view.frame.size.width-20) limitScaleRatio:3.0];
        
        __weak typeof(self) weakSelf = self ;
        imgEditorVC.finishhandle = ^(VPImageCropperViewController *controller, UIImage *image){
            
            weakSelf.portraitImageView.image = image;
